...
export class CreateTables1691446938051 implements MigrationInterface {
    name = 'CreateTables1691446938051'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vagas"."jobs" ("id" character varying NOT NULL, "description" character varying NOT NULL, "enterprise" character varying NOT NULL, "limit_date" TIMESTAMP NOT NULL, "is_active" boolean NOT NULL, "id_recruiter" uuid NOT NULL, "max_candidates" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cf0a6c42b72fcc7f7c237def345" PRIMARY KEY ("id"))`);
